...
function makeCss(c: Colors): Styles {
  ...
  return {
    phone: { width: phoneWidth, minHeight: phoneHeight, margin: "0 auto", background: c.bg, color: c.text, fontFamily: "Inter,-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif", overflow: "hidden", position: "relative" },
    app: { minHeight: phoneHeight, position: "relative", background: c.bg },
